...
<!--    <div class="mt-4 px-4 py-3 bg-blue-50 border-l-4 border-blue-400 rounded-md flex items-center" v-if="selectedLeaseId !== null">-->
<!--      <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-blue-500 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">-->
<!--        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />-->
<!--      </svg>-->
<!--&lt;!&ndash;      <span class="text-sm text-blue-700">&ndash;&gt;-->
<!--&lt;!&ndash;        Showing payments for selected property only.&ndash;&gt;-->
<!--&lt;!&ndash;        <button&ndash;&gt;-->
<!--&lt;!&ndash;            @click="emit('update:selectedLeaseId', null)"&ndash;&gt;-->
<!--&lt;!&ndash;            class="text-blue-600 hover:text-blue-800 underline font-medium ml-1">&ndash;&gt;-->
