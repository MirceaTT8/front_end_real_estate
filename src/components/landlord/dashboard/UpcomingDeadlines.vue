...
<template>
  <section class="col-span-full md:col-span-4 bg-white rounded-lg shadow p-6">
    ...
    <!-- Empty State -->
    <div v-if="!calendarEvents || calendarEvents.length === 0" class="flex flex-col items-center justify-center py-12">
      ...
      <h3 class="text-lg font-medium text-gray-900 mb-2">No Upcoming Deadlines</h3>
      <p class="text-sm text-gray-500 text-center leading-relaxed">
        You're all caught up! When you have upcoming lease expirations, payment due dates, or maintenance deadlines, they'll appear here.
      </p>
    </div>
