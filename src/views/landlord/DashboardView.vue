...
<template>
  <div class="max-w-[1400px] mx-auto px-6 py-10 space-y-8">
    <!-- Dashboard Header (Consistent with other components) -->
    <div class="col-span-full bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
      <div class="px-6 py-4 border-b border-gray-100 flex justify-between items-center">
        <div class="flex items-center">
          <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-gray-500 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" />
          </svg>
          <h1 class="text-lg font-semibold text-gray-800">Landlord Dashboard</h1>
        </div>
          ...
          <div class="px-6 py-5 flex justify-between items-center">
            <div>
              ...
              <div class="flex items-baseline mt-1">
                ...
                <span class="ml-2 text-xs font-medium text-indigo-600">+1.5%</span>
              </div>
          ...
          <div class="px-6 py-5 flex justify-between items-center">
            <div>
              ...
              <div class="flex items-baseline mt-1">
                ...
                <span class="ml-2 text-xs font-medium text-green-600">+3.2%</span>
              </div>
          ...
          <div class="px-6 py-5 flex justify-between items-center">
            <div>
              ...
              <div class="flex items-baseline mt-1">
                ...
                <span class="ml-2 text-xs font-medium text-orange-600">-2.8%</span>
              </div>
          ...
          <div class="px-6 py-5 flex justify-between items-center">
            <div>
              ...
              <div class="flex items-baseline mt-1">
                ...
                <span class="ml-2 text-xs font-medium text-blue-600">+5.7%</span>
              </div>
