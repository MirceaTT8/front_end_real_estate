  ...
  <div class="max-w-7xl mx-auto px-6 py-10">
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
      <div class="bg-white rounded-xl shadow-md p-6">
        <div class="flex items-center gap-4">
          ...
          <div>
            ...
            <p class="font-bold text-xl text-gray-800">{{ logStore.totalLogs || 0 }}</p>
          </div>
        </div>
      </div>
      ...
      <div class="bg-white rounded-xl shadow-md p-6">
        <div class="flex items-center gap-4">
          ...
          <div>
            <h3 class="text-gray-500 text-sm">Error Logs</h3>
            <p class="font-bold text-xl text-gray-800">{{ logStore.errorCount || 0 }}</p>
          </div>
        </div>
      </div>
      ...
      <div class="bg-white rounded-xl shadow-md p-6">
        <div class="flex items-center gap-4">
          ...
          <div>
            <h3 class="text-gray-500 text-sm">Warning Logs</h3>
            <p class="font-bold text-xl text-gray-800">{{ logStore.warningCount || 0 }}</p>
          </div>
        </div>
      </div>
      ...
      <div class="bg-white rounded-xl shadow-md p-6">
        <div class="flex items-center gap-4">
          ...
          <div>
            <h3 class="text-gray-500 text-sm">Info Logs</h3>
            <p class="font-bold text-xl text-gray-800">{{ logStore.infoCount || 0 }}</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-md mb-8 overflow-hidden">
      <div class="border-b border-gray-100 px-6 py-4">
        ...
        <p class="text-sm text-gray-500">Refine results by applying filters</p>
      </div>
      <div class="p-6">
        <LogFilters
    ...
    <div v-else class="bg-white rounded-xl shadow-md overflow-hidden mb-8">
      <div class="border-b border-gray-100 px-6 py-4">
        ...
        <p class="text-sm text-gray-500">{{ logStore.paginatedLogs.length }} logs found</p>
      </div>
    ...
    <div v-if="logStore.totalPages > 1" class="flex justify-center mt-8 mb-4">
      <nav class="flex items-center space-x-2">
        <button
            ...
            class="inline-flex items-center justify-center w-10 h-10 rounded-lg text-gray-500 bg-white border border-gray-300 disabled:opacity-50 disabled:cursor-not-allowed hover:bg-gray-50"
